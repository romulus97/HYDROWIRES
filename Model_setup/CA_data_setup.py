            ...
            for d in range(0,len(df_imports66)):
                if d <= len(df_imports66) - len(forecast_days):
                    for fd in forecast_days:
                        ...
                        f.write(fd + '\t' + str(d+1) + '\t' +  str(df_imports66.loc[d+fd_index,'fd1']) + '\t' + str(df_imports46.loc[d+fd_index,'fd1']) + '\t' + str(df_imports61.loc[d+fd_index,'fd1']) + '\t' + str(df_imports42.loc[d+fd_index,'fd1']) + '\t' + str(df_imports24.loc[d+fd_index,'fd1']) + '\t' + str(df_imports45.loc[d+fd_index,'fd1']) + '\t' + str(df_hydro_PGE.loc[d+fd_index,'fd1']) + '\t' + str(df_hydro_SCE.loc[d+fd_index,'fd1']) + '\n')
            ...
            for d in range(0,len(df_imports66)):
                if d <= len(df_imports66) - len(forecast_days):
                    for fd in forecast_days:
                        fd_index = forecast_days.index(fd) 
                        for h in range(0,24):                
                            f.write(fd + '\t' + str(d*24+fd_index*24+h+1) + '\t' + str(df_exports66.loc[(d+fd_index)*24+h,'fd1']) + '\t' + str(df_exports42.loc[(d+fd_index)*24+h,'fd1']) + '\t' + str(df_exports24.loc[(d+fd_index)*24+h,'fd1']) + '\t' + str(df_exports45.loc[(d+fd_index)*24+h,'fd1'])  + '\t' + str(df_SCE_hydro_mins.loc[(d+fd_index)*24+h,'fd1']) + '\t' + str(df_PGE_hydro_mins.loc[(d+fd_index)*24+h,'fd1']) + '\t' + str(df_CA_import_mins61.loc[(d+fd_index)*24+h,'fd1']) + '\t' + str(df_CA_import_mins66.loc[(d+fd_index)*24+h,'fd1']) + '\t' + str(df_CA_import_mins46.loc[(d+fd_index)*24+h,'fd1']) + '\t' + str(df_CA_import_mins42.loc[(d+fd_index)*24+h,'fd1']) + '\n')
