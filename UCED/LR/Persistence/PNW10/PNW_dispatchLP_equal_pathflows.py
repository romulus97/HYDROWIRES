# -*- coding: utf-8 -*-
"""
Created on Wed Jun 26 19:19:00 2019
...
model.ImportsConstraint1_66= Constraint(model.h1_periods,rule=ImportsC1_66)

def ImportsC2_66(model,i):
...
model.ImportsConstraint2_66= Constraint(model.h2_periods,rule=ImportsC2_66)

def ImportsC3_66(model,i):
...
model.ImportsConstraint3_66= Constraint(model.h3_periods,rule=ImportsC3_66)

def ImportsC4_66(model,i):
...
model.ImportsConstraint4_66= Constraint(model.h4_periods,rule=ImportsC4_66)

def ImportsC5_66(model,i):
...
model.ImportsConstraint5_66= Constraint(model.h5_periods,rule=ImportsC5_66)

def ImportsC6_66(model,i):
...
model.ImportsConstraint6_66= Constraint(model.h6_periods,rule=ImportsC6_66)

def ImportsC7_66(model,i):
...
model.ImportsConstraint7_66= Constraint(model.h7_periods,rule=ImportsC7_66)

def ImportsC1_65(model,i):
...
model.ImportsConstraint1_65= Constraint(model.h1_periods,rule=ImportsC1_65)

def ImportsC2_65(model,i):
...
model.ImportsConstraint2_65= Constraint(model.h2_periods,rule=ImportsC2_65)

def ImportsC3_65(model,i):
    m1 = sum(model.mwh_1['P65I',i] for i in model.h3_periods)
    m2 = sum(model.mwh_2['P65I',i] for i in model.h3_periods)
    m3 = sum(model.mwh_3['P65I',i] for i in model.h3_periods)
    return m1 + m2 + m3 <= model.HorizonPath65_imports[3]
model.ImportsConstraint3_65= Constraint(model.h3_periods,rule=ImportsC3_65)

def ImportsC4_65(model,i):
    m1 = sum(model.mwh_1['P65I',i] for i in model.h4_periods)
    m2 = sum(model.mwh_2['P65I',i] for i in model.h4_periods)
    m3 = sum(model.mwh_3['P65I',i] for i in model.h4_periods)
    return m1 + m2 + m3 <= model.HorizonPath65_imports[4]
model.ImportsConstraint4_65= Constraint(model.h4_periods,rule=ImportsC4_65)

def ImportsC5_65(model,i):
    m1 = sum(model.mwh_1['P65I',i] for i in model.h5_periods)
    m2 = sum(model.mwh_2['P65I',i] for i in model.h5_periods)
    m3 = sum(model.mwh_3['P65I',i] for i in model.h5_periods)
    return m1 + m2 + m3 <= model.HorizonPath65_imports[5]
model.ImportsConstraint5_65= Constraint(model.h5_periods,rule=ImportsC5_65)

def ImportsC6_65(model,i):
    m1 = sum(model.mwh_1['P65I',i] for i in model.h6_periods)
    m2 = sum(model.mwh_2['P65I',i] for i in model.h6_periods)
    m3 = sum(model.mwh_3['P65I',i] for i in model.h6_periods)
    return m1 + m2 + m3 <= model.HorizonPath65_imports[6]
model.ImportsConstraint6_65= Constraint(model.h6_periods,rule=ImportsC6_65)

def ImportsC7_65(model,i):
    m1 = sum(model.mwh_1['P65I',i] for i in model.h7_periods)
    m2 = sum(model.mwh_2['P65I',i] for i in model.h7_periods)
    m3 = sum(model.mwh_3['P65I',i] for i in model.h7_periods)
    return m1 + m2 + m3 <= model.HorizonPath65_imports[7]
model.ImportsConstraint7_65= Constraint(model.h7_periods,rule=ImportsC7_65)


def ImportsC1_3(model,i):
...
model.ImportsConstraint1_3= Constraint(model.h1_periods,rule=ImportsC1_3)

def ImportsC2_3(model,i):
...
model.ImportsConstraint2_3= Constraint(model.h2_periods,rule=ImportsC2_3)

def ImportsC3_3(model,i):
    m1 = sum(model.mwh_1['P3I',i] for i in model.h3_periods)
    m2 = sum(model.mwh_2['P3I',i] for i in model.h3_periods)
    m3 = sum(model.mwh_3['P3I',i] for i in model.h3_periods)
    return m1 + m2 + m3 <= model.HorizonPath3_imports[3]
model.ImportsConstraint3_3= Constraint(model.h3_periods,rule=ImportsC3_3)

def ImportsC4_3(model,i):
    m1 = sum(model.mwh_1['P3I',i] for i in model.h4_periods)
    m2 = sum(model.mwh_2['P3I',i] for i in model.h4_periods)
    m3 = sum(model.mwh_3['P3I',i] for i in model.h4_periods)
    return m1 + m2 + m3 <= model.HorizonPath3_imports[4]
model.ImportsConstraint4_3= Constraint(model.h4_periods,rule=ImportsC4_3)

def ImportsC5_3(model,i):
    m1 = sum(model.mwh_1['P3I',i] for i in model.h5_periods)
    m2 = sum(model.mwh_2['P3I',i] for i in model.h5_periods)
    m3 = sum(model.mwh_3['P3I',i] for i in model.h5_periods)
    return m1 + m2 + m3 <= model.HorizonPath3_imports[5]
model.ImportsConstraint5_3= Constraint(model.h5_periods,rule=ImportsC5_3)

def ImportsC6_3(model,i):
    m1 = sum(model.mwh_1['P3I',i] for i in model.h6_periods)
    m2 = sum(model.mwh_2['P3I',i] for i in model.h6_periods)
    m3 = sum(model.mwh_3['P3I',i] for i in model.h6_periods)
    return m1 + m2 + m3 <= model.HorizonPath3_imports[6]
model.ImportsConstraint6_3= Constraint(model.h6_periods,rule=ImportsC6_3)

def ImportsC7_3(model,i):
    m1 = sum(model.mwh_1['P3I',i] for i in model.h7_periods)
    m2 = sum(model.mwh_2['P3I',i] for i in model.h7_periods)
    m3 = sum(model.mwh_3['P3I',i] for i in model.h7_periods)
    return m1 + m2 + m3 <= model.HorizonPath3_imports[7]
model.ImportsConstraint7_3= Constraint(model.h7_periods,rule=ImportsC7_3)


def ImportsC1_8(model,i):
...
model.ImportsConstraint1_8= Constraint(model.h1_periods,rule=ImportsC1_8)

def ImportsC2_8(model,i):
...
model.ImportsConstraint2_8= Constraint(model.h2_periods,rule=ImportsC2_8)

def ImportsC3_8(model,i):
    m1 = sum(model.mwh_1['P8I',i] for i in model.h3_periods)
    m2 = sum(model.mwh_2['P8I',i] for i in model.h3_periods)
    m3 = sum(model.mwh_3['P8I',i] for i in model.h3_periods)
    return m1 + m2 + m3 <= model.HorizonPath8_imports[3]
model.ImportsConstraint3_8= Constraint(model.h3_periods,rule=ImportsC3_8)

def ImportsC4_8(model,i):
    m1 = sum(model.mwh_1['P8I',i] for i in model.h4_periods)
    m2 = sum(model.mwh_2['P8I',i] for i in model.h4_periods)
    m3 = sum(model.mwh_3['P8I',i] for i in model.h4_periods)
    return m1 + m2 + m3 <= model.HorizonPath8_imports[4]
model.ImportsConstraint4_8= Constraint(model.h4_periods,rule=ImportsC4_8)

def ImportsC5_8(model,i):
    m1 = sum(model.mwh_1['P8I',i] for i in model.h5_periods)
    m2 = sum(model.mwh_2['P8I',i] for i in model.h5_periods)
    m3 = sum(model.mwh_3['P8I',i] for i in model.h5_periods)
    return m1 + m2 + m3 <= model.HorizonPath8_imports[5]
model.ImportsConstraint5_8= Constraint(model.h5_periods,rule=ImportsC5_8)

def ImportsC6_8(model,i):
    m1 = sum(model.mwh_1['P8I',i] for i in model.h6_periods)
    m2 = sum(model.mwh_2['P8I',i] for i in model.h6_periods)
    m3 = sum(model.mwh_3['P8I',i] for i in model.h6_periods)
    return m1 + m2 + m3 <= model.HorizonPath8_imports[6]
model.ImportsConstraint6_8= Constraint(model.h6_periods,rule=ImportsC6_8)

def ImportsC7_8(model,i):
    m1 = sum(model.mwh_1['P8I',i] for i in model.h7_periods)
    m2 = sum(model.mwh_2['P8I',i] for i in model.h7_periods)
    m3 = sum(model.mwh_3['P8I',i] for i in model.h7_periods)
    return m1 + m2 + m3 <= model.HorizonPath8_imports[7]
model.ImportsConstraint7_8= Constraint(model.h7_periods,rule=ImportsC7_8)


def ImportsC1_14(model,i):
...
model.ImportsConstraint1_14= Constraint(model.h1_periods,rule=ImportsC1_14)

def ImportsC2_14(model,i):
...
model.ImportsConstraint2_14= Constraint(model.h2_periods,rule=ImportsC2_14)

def ImportsC3_14(model,i):
    m1 = sum(model.mwh_1['P14I',i] for i in model.h3_periods)
    m2 = sum(model.mwh_2['P14I',i] for i in model.h3_periods)
    m3 = sum(model.mwh_3['P14I',i] for i in model.h3_periods)
    return m1 + m2 + m3 <= model.HorizonPath14_imports[3]
model.ImportsConstraint3_14= Constraint(model.h3_periods,rule=ImportsC3_14)

def ImportsC4_14(model,i):
    m1 = sum(model.mwh_1['P14I',i] for i in model.h4_periods)
    m2 = sum(model.mwh_2['P14I',i] for i in model.h4_periods)
    m3 = sum(model.mwh_3['P14I',i] for i in model.h4_periods)
    return m1 + m2 + m3 <= model.HorizonPath14_imports[4]
model.ImportsConstraint4_14= Constraint(model.h4_periods,rule=ImportsC4_14)

def ImportsC5_14(model,i):
    m1 = sum(model.mwh_1['P14I',i] for i in model.h5_periods)
    m2 = sum(model.mwh_2['P14I',i] for i in model.h5_periods)
    m3 = sum(model.mwh_3['P14I',i] for i in model.h5_periods)
    return m1 + m2 + m3 <= model.HorizonPath14_imports[5]
model.ImportsConstraint5_14= Constraint(model.h5_periods,rule=ImportsC5_14)

def ImportsC6_14(model,i):
    m1 = sum(model.mwh_1['P14I',i] for i in model.h6_periods)
    m2 = sum(model.mwh_2['P14I',i] for i in model.h6_periods)
    m3 = sum(model.mwh_3['P14I',i] for i in model.h6_periods)
    return m1 + m2 + m3 <= model.HorizonPath14_imports[6]
model.ImportsConstraint6_14= Constraint(model.h6_periods,rule=ImportsC6_14)

def ImportsC7_14(model,i):
    m1 = sum(model.mwh_1['P14I',i] for i in model.h7_periods)
    m2 = sum(model.mwh_2['P14I',i] for i in model.h7_periods)
    m3 = sum(model.mwh_3['P14I',i] for i in model.h7_periods)
    return m1 + m2 + m3 <= model.HorizonPath14_imports[7]
model.ImportsConstraint7_14= Constraint(model.h7_periods,rule=ImportsC7_14)
